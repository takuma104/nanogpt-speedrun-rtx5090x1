...
| 2026-09-03 | 1093.1 s | 3.2766 | `logs/345def6d-2a4c-4067-be97-4e8658b42cf4.txt` | Exp 13: 部分的 log-Q 補正 (×0.5)。val にマージンが戻る |
| 2026-09-03 | **1074.3 s** | 3.2782 | `logs/ec707ab7-0811-477e-a038-5fbba6b381d7.txt` | Exp 15: P ランプ無し + full-softmax 尾 60 step + 拡張 30 step（現在の記録構成、baseline 比 −36.9%） |
